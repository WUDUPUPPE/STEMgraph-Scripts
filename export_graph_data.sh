...
OUTPUT_FILE="$DATA_DIR/graph-data.json"                         # Pfad zur graph-data.json, die ich erzeugen möchte
STATS_FILE="$DATA_DIR/stats_export.json"                        # Datei, in die ich am Ende die Export-Statistik schreibe
